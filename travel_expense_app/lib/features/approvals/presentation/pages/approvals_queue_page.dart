...
class _ApprovalsQueuePageState extends ConsumerState<ApprovalsQueuePage> {
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                ref.read(approvalsNotifierProvider.notifier).rejectApprovalStage(stageId, reason);
              },
  ...
  Widget build(BuildContext context) {
    ...
    // Listen to success states or error states
    ...
    // Enforce role check on render as fallback
    final role = authState.user?.role.toLowerCase() ?? '';
    final isAuthorized = role.contains('manager') || role.contains('finance') || role.contains('admin');
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Access Denied',
                  style: AppTypography.h2(isDark ? Colors.white : AppColors.textPrimaryLight),
                ),
      ...
      body: Builder(
        builder: (context) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(
                      'No pending travel request approvals await your review.',
                      textAlign: TextAlign.center,
                      style: AppTypography.bodyMedium(
                        isDark ? AppColors.textSecondaryDark : AppColors.textSecondaryLight,
                      ),
          ...
          return RefreshIndicator(
            onRefresh: () async {
              await ref.read(approvalsNotifierProvider.notifier).loadPendingApprovals();
            },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                ...
                                style: AppTypography.bodySmall(AppColors.warning).copyWith(
                                  fontWeight: FontWeight.bold,
                                ),
                              ),
                            ),
